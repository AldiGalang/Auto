...
gaianet init --base $HOME/gaia-node-102 config --chat-url https://huggingface.co/gaianet/Qwen2.5-0.5B-Instruct-GGUF/resolve/main/Qwen2.5-0.5B-Instruct-Q5_K_M.gguf --prompt-template chatml
